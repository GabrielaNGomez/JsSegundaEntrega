...
class reserva {
    constructor(fecha, hora, nombre, modelo) {
        this.fecha = fecha;
        this.hora = hora;
        this.nombre = nombre;
        this.modelo = modelo;
  ...
  const calendarioDeReservas = {
    ...
    agregarReserva: function(fecha, hora, nombre, modelo) {
      const nuevaReserva = new reserva(fecha, hora, nombre, modelo);
    ...
    mostrarReservas: function() {
      ...
      this.reservas.forEach(function(reserva) {
        console.log('Fecha:', reserva.fecha, 'Hora:', reserva.hora, 'Nombre:', reserva.nombre, 'Modelo:', reserva.modelo);
      });
    },
    ...
    filtrarReservasPorFecha: function(fecha) {
      ...
      reservasFiltradas.forEach(function(reserva) {
        console.log('Hora:', reserva.hora, 'Nombre:', reserva.nombre, 'Modelo:', reserva.modelo);
      });
    }
  };
